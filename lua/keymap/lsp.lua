...
function _LSP_MAP(buffnr)
    ...
    key.nmap({
    { '<space>e', vim.diagnostic.open_float, nore_silent },
    ...
    { 'gh', vim.lsp.buf.hover, nore_silent_buf },
    { 'gi', vim.lsp.buf.implementation, nore_silent_buf },
    { 'gr', vim.lsp.buf.references, nore_silent_buf },
    { '<C-k>', vim.lsp.buf.signature_help, nore_silent_buf },
    { '<space>q', vim.diagnostic.setloclist, nore_silent },
    { '<space>wa', vim.lsp.buf.add_workspace_folder, nore_silent_buf },
    { '<space>wr', vim.lsp.buf.remove_workspace_folder, nore_silent_buf },
    { '<space>wl', function()print(vim.inspect(vim.lsp.buf.list_workspace_folders())) end, nore_silent_buf },
    { '<space>D', vim.lsp.buf.type_definition, nore_silent_buf },
    { '<space>rn', vim.lsp.buf.rename, nore_silent_buf },
    { '<space>.', vim.lsp.buf.code_action, nore_silent_buf },
    { '<space>z', vim.lsp.buf.formatting, nore_silent_buf },
    })
end
...
function _CMP_MAP(cmp,luasnip,select_behavior)
 local insert_map = cmp.mapping.preset.insert()
  ...
  rawset(insert_map, '<Tab>', cmp.mapping(super_tab(cmp,luasnip,select_behavior),{'i','c'}))
  rawset(insert_map, '<S-Tab>', cmp.mapping(super_s_tab(cmp,luasnip,select_behavior),{'i','c'}))
