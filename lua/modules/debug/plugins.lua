...
plugin({'theHamsta/nvim-dap-virtual-text',config = conf('nvim-dap-virtual-text'),requires = {"mfussenegger/nvim-dap"}})
plugin({'rcarriga/nvim-dap-ui', config = conf('nvim-dap-ui'),requires = {"mfussenegger/nvim-dap"}})
