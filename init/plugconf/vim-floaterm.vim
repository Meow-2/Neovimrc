...
nnoremap <silent> <c-g> :FloatermNew! --cwd=<root> --name=lazygit lazygit<cr>
tnoremap <silent><expr> <c-g> 
       \ &filetype == 'floaterm' ? 
       \ "q<C-\><C-N>:FloatermKill lazygit<cr>" :
       \ "<c-g>"

nnoremap <silent> <S-F3> :set norelativenumber<cr>:FloatermNew! --cmd=<root> --width=0.5 --position=belowright --wintype=vsplit --name=lldb lldb %:h/build/%:t:r<cr>
